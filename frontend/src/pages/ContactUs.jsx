    ...
    <div className="w-full min-h-screen bg-gradient-to-b from-gray-900 to-gray-800 text-white py-12 px-6">
      ...
      >
        ...
        <p className="text-lg md:text-xl text-gray-300 max-w-2xl mx-auto">
          ...
          We specialize in Web Maintenance, Web Development, and Data Analytics.
        </p>
      </motion.div>
      ...
      <div className="grid md:grid-cols-3 gap-8 mb-20">
        ...
        >
          ...
          <p className="text-gray-400">
            We build modern, scalable, and responsive websites tailored to your
      ...
      <div className="mb-20">
        ...
        <div className="grid md:grid-cols-2 gap-8">
          ...
          >
            ...
            <p className="text-gray-400">✉️ robertgathanua@gmai.com</p>
          </motion.div>
        </div>
      </div>
