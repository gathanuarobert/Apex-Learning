        ...
        <div className="hidden md:flex w-1/3 bg-gradient-to-br from-blue-700 via-blue-800 to-indigo-950 p-10 flex-col justify-between text-white">
          <div>
            ...
            <p className="text-blue-100/70 mt-3 text-sm leading-relaxed">
              Unlock your potential with Kenya's leading learning management
              system.
            </p>
          </div>
                ...
                <div className="space-y-2">
                  <div className="relative">
                    ...
                    <button
                      ...
                      className="absolute right-5 top-4 text-gray-500 hover:text-white transition-colors"
                    >
                  ...
                  {formData.password && (
                    <div className="flex gap-1 px-1">
                      {[1, 2, 3, 4].map((step) => (
                        <div
                          key={step}
                          className={`h-1 flex-1 rounded-full transition-colors ${passwordStrength.score >= step ? "bg-blue-500" : "bg-white/10"}`}
                        />
                      ))}
                    </div>
                  )}
                ...
                {role === "student" && (
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <select
                      name="educationLevel"
                      onChange={handleChange}
                      className="bg-gray-800 text-sm border-white/10 rounded-2xl px-5 py-4 outline-none focus:ring-2 focus:ring-blue-500"
                    >
